...
export class PersonState {
    ...
    public async merge(
        ...
        if (isDistinctIdIllegal(mergeIntoDistinctId)) {
            const kafkaAck = captureIngestionWarning(
    ...
    public async mergePeople({
        ...
        if (!mergeAllowed) {
            ...
            return [mergeInto, kafkaAck] // We're returning the original person tied to distinct_id used for the event
        }
